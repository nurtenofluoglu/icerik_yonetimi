...
# --- 🌿 NURTEN ŞEFİN ZENGİN İÇERİKLİ YAPAY ZEKA MOTORU ---
...
def yapay_zeka_icerik_uret(bitki_adi):
    ...
    if "domates" in bitki:
        return [
            ...
            {"type": "paragraph", "children": [{"type": "text", "text": "İçeriğindeki yüksek potasyum ve lifler sayesinde kan basıncını (tansiyonu) dengeler, kötü kolesterolü düşürür ve kalp damar sağlığını korumada mucizevi etkiler gösterir. Ayrıca düşük kalorili yapısıyla diyetlerin vazgeçilmezidir."}]}
        ]
...
try:
    ...
    if res_get.ok:
        ...
        for b in bitkiler:
            ...
            baslik = veri_alani.get("Nurten") or "Başlıksız Bitki"
        ...
        print("🎉 MÜKEMMEL: Tüm bitki açıklamaları en zengin ve uzun haliyle güncellendi şefim!")
